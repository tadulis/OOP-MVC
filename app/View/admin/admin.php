          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="/<?= CONFIG['site_path']?>/assets/images/faces/face12.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="/<?= CONFIG['site_path']?>/assets/images/faces/face1.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="/<?= CONFIG['site_path']?>/assets/images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"> Henry Klein </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face8.jpg" alt="Profile image">
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                  <img class="img-xs rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face8.jpg" alt="profile image">
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face1.jpg" alt="profile image"> Katie Holmes </td>
                            <td>$3621</td>
                            <td><img src="/<?= CONFIG['site_path']?>/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>04 Jun 2019</td>
                            <td>18 Jul 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face2.jpg" alt="profile image"> Minnie Copeland </td>
                            <td>$6245</td>
                            <td><img src="/<?= CONFIG['site_path']?>/assets/images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                            <td>25 Sep 2019</td>
                            <td>07 Oct 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face3.jpg" alt="profile image"> Rodney Sims </td>
                            <td>$9265</td>
                            <td><img src="/<?= CONFIG['site_path']?>/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>12 dec 2019</td>
                            <td>26 Aug 2019</td>
                          ...
                          <tr>
                            <td>
                              <img class="img-sm rounded-circle" src="/<?= CONFIG['site_path']?>/assets/images/faces/face4.jpg" alt="profile image"> Carolyn Barker </td>
                            <td>$2263</td>
                            <td><img src="/<?= CONFIG['site_path']?>/assets/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                            <td>30 Sep 2019</td>
                            <td>20 Oct 2019</td>
