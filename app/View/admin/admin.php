                            ...
                            <div class="card-body">
                                ...
                                <div class="aligner-wrapper">
                                    ...
                                    <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                                        <h2 class="text-center mb-0 font-weight-bold"><?= count($data['allUsersdata']); ?></h2>
                    ...
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body performane-indicator-card">
                                <div class="d-sm-flex">
                                    <h4 class="card-title flex-shrink-1">Last five users data:</h4>
                                </div>
                                ...
                                <div class="table-responsive border rounded p-1">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="img-sm rounded-circle"
                                                     src="/<?= CONFIG['site_path'] ?>/assets/images/faces/face1.jpg"
                                                     alt="profile image"> Katie Holmes
                                            </td>
                                            <td>$3621</td>
                                            <td>
                                                <img src="/<?= CONFIG['site_path'] ?>/assets/images/dashboard/alipay.png"
                                        ...
                                        <tr>
                                            <td>
                                                <img class="img-sm rounded-circle"
                                                     src="/<?= CONFIG['site_path'] ?>/assets/images/faces/face2.jpg"
                                                     alt="profile image"> Minnie Copeland
                                            </td>
                                            <td>$6245</td>
                                            <td>
                                                <img src="/<?= CONFIG['site_path'] ?>/assets/images/dashboard/paypal.png"
                                        ...
                                        <tr>
                                            <td>
                                                <img class="img-sm rounded-circle"
                                                     src="/<?= CONFIG['site_path'] ?>/assets/images/faces/face3.jpg"
                                        ...
                                        <tr>
                                            <td>
                                                <img class="img-sm rounded-circle"
                                                     src="/<?= CONFIG['site_path'] ?>/assets/images/faces/face4.jpg"
